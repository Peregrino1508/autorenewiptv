...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-purple-500 to-blue-700 flex items-center justify-center p-4">
      {/* Animated background grid */}
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#3b82f640_1px,transparent_1px),linear-gradient(to_bottom,#8b5cf640_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] animate-pulse" />
      
      <Card className="w-full max-w-2xl relative z-10 bg-white/30 backdrop-blur-xl border-white/30 shadow-2xl shadow-purple-700/40">
